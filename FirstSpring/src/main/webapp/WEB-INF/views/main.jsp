		...
		<div class="row">
				...
				<form action="" method="post">
					<div>
						<div class="text-right">
							<span >전체${fn:length(alltBoardList)}건 이상</span>
						</div>
					</div>
			...
			<div class="col-md-6">
				...
				<form action="" method="post">
					<div>
						<div class="text-right">
							<span >전체 ${fn:length(allNoticeList)}건</span>
						</div>
					</div>
					<div style="padding-top: 50px">
						<table class="table">
