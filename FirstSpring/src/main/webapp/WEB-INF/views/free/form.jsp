...
<body>
	...
	<div class="container">
		<form name="newWrite" action="/free/insert.do" class="form-horizontal" method="post" id="newWrite">
			<c:if test="${status eq 'u'}">
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<input id="boTitle" name="boTitle" type="text" class="form-control" placeholder="subject" value="${free.boTitle }">
				</div>
			</div>
			<div class="form-group row">
...
<script type="text/javascript">
	$(function(){
		...
		formBtn.on('click',function(){
			...
			if($(this).val()=="수정"){
				$('#newWrite').attr("action","/free/update.do");
			}
