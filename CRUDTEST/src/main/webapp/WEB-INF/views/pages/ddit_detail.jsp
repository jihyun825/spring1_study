		  ...
		  <div class="col-md-8">
		    <div class="h-100">
              ...
              <p class="mb-0 font-weight-normal text-sm">
                ${board.bodate } / ${board.bowriter }/${board.bohit }
              </p>
            </div>
		  </div>
		</div>
            ...
            <div class="col-md-12">
              <div class="card card-plain h-100">
				...
				<div class="card-footer p-3">
				  <button type="button" class="btn btn-outline-primary" id="boardDel">삭제</button>
				  <button type="button" class="btn btn-outline-secondary" id="boardMod">수정</button>
				  <button type="button" class="btn btn-outline-success" id="boardList">목록</button>
				</div>
              </div>
            </div>
        </div>
